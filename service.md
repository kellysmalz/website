...
**[Data Science Clinic](https://datascience.uchicago.edu/education/data-science-clinic/), UChicago**
  - **Mentor**,  [Spring 2026](https://clinic.ds.uchicago.edu/projects/) My team partnered with [UChicago's Regenstein Library](https://www.lib.uchicago.edu/spaces/joseph-regenstein-library/) to assess the replaceability of its collection, estimate replacement costs for obtainable titles, and identify distinguishing characteristics of irreplaceable works.
  
  - **Mentor**, [Winter 2026](https://clinic.ds.uchicago.edu/projects/one-pagers/2026-winter/Mothers%20Out%20Front.pdf)  My team partnered with Mothers Out Front to enhance the Climate Lens dashboard, optimizing backend data processing efficiency by streamlining workflows and creating a more intuitive, accessible, and informative interface for stakeholders.
 
  - **Mentor**, [Fall 2025](https://clinic.ds.uchicago.edu/projects/one-pagers/2025-autumn/Mothers%20Out%20Front.pdf) My team partnered with [Mothers Out Front](https://mothersoutfront.org/), to develop a tool that presents relevant environmental data in a clear, accessible format, empowering families and activists to assess their school's environmental conditions and identify actionable opportunities for improvement.

  - **Mentor**, [Spring 2025](https://clinic.ds.uchicago.edu/projects/one-pagers/2025-spring/RAFI%20-%20Grocery.pdf) My team partnered with RAFI to develop visualizations and predictive models analyzing grocery market concentration across the United States. The analysis examined socioeconomic and demographic factors, including income and urbanization, potentially linked to market concentration. Findings revealed that the strongest predictor of concentration was the prior year's level, while factors such as political affiliation and education level proved to be less informative indicators.
    
  - **Mentor**, [Winter 2025](https://clinic.ds.uchicago.edu/projects/one-pagers/2025-winter/RAFI%20-%20Grocery.pdf) My team partnered with RAFI to develop visualizations of grocery market concentration and food access metrics across core-based statistical areas (CBSAs), while conducting an in-depth analysis of the geographic factors influencing these metrics.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;and evaluation, student advising, donor engagement, and annual reporting. Developed new courses and 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;contributed to new degree pathways, including data analytics. 
...
**UChicago Laboratory School** Volunteer, UChicago Laboratory School *(2024–Present)*

**Chicago Food Depository**, Volunteer, *(2024, 2025, 2026)*

**Metrolina Regional Scholars Academy**, Room Parent and Volunteer, *(2022–2024)*

---

### Professional Memberships

Pi Mu Epsilon Mathematics Honor Society &nbsp;·&nbsp; American Mathematical Society &nbsp;·&nbsp; Mathematical Association of America
